...
public class GrupSonucListViewAdapter extends BaseAdapter {
    ...
    public GrupSonucListViewAdapter(Context context, List<Gruplar> katilimcilist) {
        mContext = context;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Log.d("id"+ id ," ");
                Intent i = new Intent (mContext,GrupSonucDetayActivity.class);
                i.putExtra("id",id);
