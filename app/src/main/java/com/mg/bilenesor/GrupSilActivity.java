...
public class GrupSilActivity extends ActionBarActivity {
    Context mContext;
    String olusturan_id;
    ListView list;
    GrupSilListViewAdapter adapter;
    EditText editsearch;
    ...
    class fillAdapter extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(GrupSilActivity.this);
        ...
        protected void onPostExecute(Void args) {
            ...
            adapter = new GrupSilListViewAdapter(GrupSilActivity.this, arraylist);
