...
public class GrupSonucDetayActivity extends ActionBarActivity {
    String grup_id;
    ListView list;
    ...
    class fillAdapter extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(GrupSonucDetayActivity.this);
        ...
        protected void onPostExecute(Void args) {
            ...
            adapter = new GrupSonucDetayListViewAdapter(GrupSonucDetayActivity.this, arraylist);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_grup_sonuc_detay, menu);
...
// TODO Auto-generated method stub
        switch(item.getItemId()){
            case R.id.sonuc:
                Intent yeni=new Intent(GrupSonucDetayActivity.this, Sonuclar.class);
                startActivity(yeni);break;
            case R.id.gruplarim:
                Intent yeni1=new Intent(GrupSonucDetayActivity.this, MainActivity.class);
